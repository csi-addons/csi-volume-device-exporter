IMAGE_REPO   ?= quay.io/csiaddons/k8s-volume-device-exporter
IMAGE_TAG    ?= latest
...
.PHONY: all build generate test test-e2e test-alerts image push deploy deploy-podmonitor deploy-openshift undeploy clean lint vet fmt check-all-committed help
