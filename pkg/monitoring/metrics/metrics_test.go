...
func TestSetLastSuccessfulNow_UpdatesGauge(t *testing.T) {
	...
	expected := `
# HELP csiaddons_volume_device_exporter_last_successful_discovery_timestamp_seconds Unix timestamp of last successful discovery cycle.
# TYPE csiaddons_volume_device_exporter_last_successful_discovery_timestamp_seconds gauge
`
	...
	for _, mf := range gathered {
		if mf.GetName() == "csiaddons_volume_device_exporter_last_successful_discovery_timestamp_seconds" {
			found = true
